document.addEventListener('DOMContentLoaded', function () {
    ...
    function renderCategories() {
        ...
        if (!categories.length) {
            tableBody.innerHTML = '<tr class="no-data-row"><td colspan="3" style="text-align:center;color:#94a3b8;">No categories found</td></tr>';
            updateShowingInfo(0, '');
            return;
        }
        ...
        categories.forEach(function (item) {
            ...
            tr.innerHTML = ''
                ...
                + '<td class="category-id">' + item.id + '</td>'
        ...
        tableBody.addEventListener('click', function (e) {
            ...
            if (deleteBtn) {
                ...
                Swal.fire({
                    ...
                    try {
                        const response = await fetch('/api/categories/' + rowId, {
                            method: 'DELETE'
                        });
