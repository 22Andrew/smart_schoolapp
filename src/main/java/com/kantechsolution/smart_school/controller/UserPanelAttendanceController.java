...
@RestController
@RequestMapping("/api/user/user/attendance")
@RequiredArgsConstructor
public class UserPanelAttendanceController {

    private final UserPanelAttendanceService userPanelAttendanceService;

    @GetMapping
    public ResponseEntity<?> getProfileAttendance(Authentication authentication) {
        try {
            return ResponseEntity.ok(userPanelAttendanceService.getProfileAttendance(authentication));
