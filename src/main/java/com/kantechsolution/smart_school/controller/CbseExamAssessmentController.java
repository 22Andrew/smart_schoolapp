...
public class CbseExamAssessmentController {
    ...
    public String showCbseExamAssessmentPage(Authentication authentication) {
        return staffSessionService.superAdminView(authentication, "cbseexam-cbseassessment-index");
    }
