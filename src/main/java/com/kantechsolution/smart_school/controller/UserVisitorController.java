...
public class UserVisitorController {
    ...
    public String visitorList(Model model, Authentication authentication) {
        userPanelContextService.populateLayoutModel(model, authentication, "visitor-book", "Visitor List");
        return "user-visitor";
    }

    @GetMapping({"/visitor-book", "/visitors"})
