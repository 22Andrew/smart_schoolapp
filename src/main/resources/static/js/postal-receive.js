...
async function viewReceive(id) {
    try {
        ...
        document.getElementById('detailToTitle').textContent = displayValue(receive.toTitle);
        document.getElementById('detailReferenceNo').textContent = displayValue(receive.referenceNo);
        document.getElementById('detailFromTitle').textContent = displayValue(receive.fromTitle);
        document.getElementById('detailDate').textContent = formatDate(receive.date);
        document.getElementById('detailAddress').textContent = displayValue(receive.address);
        document.getElementById('detailNote').textContent = displayValue(receive.note);
        ...
        Swal.fire({
            icon: 'error',
            title: 'Error',
            text: 'Failed to load receive details',
            confirmButtonText: 'OK',
            confirmButtonColor: '#ef4444'
        });
    }
